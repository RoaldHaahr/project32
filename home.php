...
<?php include_once('header.php'); ?>
	...
	<nav id="front-page" class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand navbar-brand-home" href="home.php"><img src="images/logowhite.png" alt="Tellastory logo"></a>
			</div>
			<div>
            <?php
	session_start();
	if(isset($_SESSION['loggedOn'])) {
		...
		<li><a href="myProfile.php" id="nav-profile-picture"><img  alt="Profile picture" src="showProfilePicture.php?ID=' . $_SESSION['userID'] . '"></a></li>
