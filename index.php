...
experience and give amazing and unique present to your friends. Check newest events in Aarhus. Meet local folks and learn new things about Danish culture from them. Enjoy your time in Aarhus!
  ...
  <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
					...
					<!---<a href="#" id="left-arrow" onClick="second();"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></a>
				</div>
				<div class="col-md-8">
					<article id="welcome">
...
experience and give amazing and unique present to your friends. Check newest events in Aarhus. Meet local folks and learn new things about Danish culture from them. Enjoy your time in Aarhus!
				...
				<div class="col-md-2">
					<a href="#" id="right-arrow" onClick="third();"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a>
				</div>
			</div>
		</div>	
	</section>
